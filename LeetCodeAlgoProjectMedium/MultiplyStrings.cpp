 ...
 * working backward from the end of each input number. We pre-allocate our result and accumulate our partial result in there.
...
int main(){
	...
	cout<<multiply("122","12")<<endl;
	cout<<multiply("312","132")<<endl;
	cout<<multiply("142","152")<<endl;
	cout<<multiply("13","12")<<endl;
